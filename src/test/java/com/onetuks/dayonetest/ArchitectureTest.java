...
class ArchitectureTest {
    ...
    void setUp() {
        javaClasses = new ClassFileImporter()
                ...
                .importPackages("com.onetuks.dayonetest");
    }
    ...
    class ClassNameTest {
        ...
        void controller_ClassNamePostfix_Test() {
            ArchRule classNameRule = ArchRuleDefinition.classes()
                    .that().resideInAnyPackage("..controller")
                    .should().haveSimpleNameEndingWith("Api");

            ArchRule annotationRule = ArchRuleDefinition.classes()
                    .that().resideInAnyPackage("..controller")
                    .should().beAnnotatedWith(RestController.class)
                    .orShould().beAnnotatedWith(Container.class);
